...
void LoadDrawables()
{
    ...
    MDrawableResources::CreateDrawableData(G_ASSET_NAME_TERRAIN, {G_ASSET_MESH_TERRAIN, "", "", G_ASSET_T_COLOR_TERRAIN, G_ASSET_T_NORMAL_TERRAIN, G_ASSET_T_NONE_DARK, G_ASSET_T_MRO_TERRAIN, false});
